 ...
 *
 */
class FaviconAction extends ControllerBase implements ControllerInterface{
    ...
    private function modelAction(){
        ...
        # Get logo name
        $logoName = $this->parameters['favicon_name'];

        try{

            # Search file in "/resources/png/logo/"
            $this->model->getFile($logoName, __ROOT_APP__."resources/favicon/", ["png", "ico", "svg", "xml"]);
